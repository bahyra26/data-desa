    ...
    <section class="card form-card">
        <form action="{{ route('perangkat.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="field">
                ...
                <input type="date" id="mulai_menjabat" name="mulai_menjabat" value="{{ old('mulai_menjabat') }}">
                @error('mulai_menjabat') <div class="error">{{ $message }}</div> @enderror
            </div>

            <div class="field">
                <label for="akhir_menjabat">Tanggal Akhir Menjabat</label>
                <input type="date" id="akhir_menjabat" name="akhir_menjabat" value="{{ old('akhir_menjabat') }}">
            ...
            <div class="field">
                ...
                <select id="status" name="status">
                    ...
                    <option value="pensiun" @selected(old('status') === 'pensiun')>Pensiun</option>
                </select>
...
@push('scripts')
    <script>
        ...
        let selectedKecamatan = '{{ old('kecamatan_id') }}';
        let selectedWilayah = '{{ old('wilayah_id') }}';
        let selectedJabatan = '{{ old('jabatan_perangkat_id') }}';
